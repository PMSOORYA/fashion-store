...
export const HERO_IMAGE = "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=2000&q=85";
export const LOGIN_IMAGE = "https://images.unsplash.com/photo-1469334031218-e382a71b716b?auto=format&fit=crop&w=1200&q=85";
...
export const PRODUCTS: Product[] = [
  {
    ...
    category: "Maxi Dress",
    description: "Crafted from liquid-shine Mulberry silk satin, this floor-sweeping maxi dress features a delicate cowl neckline and a plunging open back secured by hand-rolled spaghetti ties. Elegant, sensual, and effortlessly sophisticated.",
    price: 495,
    originalPrice: 620,
    rating: 4.9,
    reviewCount: 42,
    sizes: ["XS", "S", "M", "L", "XL"],
    colors: [
      { name: "Champagne Gold", hex: "#EADBC8" },
  ...
  },
  {
    ...
    stock: 12,
    thumbnail: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&w=1000&q=80",
    galleryImages: [
      "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    category: "Mini Dress",
    description: "Sculpted from Italian plush velvet, this dramatic mini dress incorporates interior boning for immaculate structure, paired with a subtle sweetheart bust and off-the-shoulder draped sleeves.",
    price: 380,
    originalPrice: 450,
    rating: 4.9,
    reviewCount: 58,
  ...
  },
  {
    ...
    sizes: ["XS", "S", "M", "L", "XL"],
    colors: [
      { name: "Garden Rose", hex: "#E8D3D3" },
      { name: "Sage Mist", hex: "#C7D3C7" }
    ],
    material: "100% Silk Organza with Viscose Slip Lining",
    careInstructions: "Professional dry clean only.",
    stock: 5,
    thumbnail: "https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&w=1000&q=80",
    galleryImages: [
  ...
  },
  {
    ...
    careInstructions: "Specialist dry clean only. Store hanging in protective garmet bag.",
    stock: 4,
    thumbnail: "https://images.unsplash.com/photo-1568252542512-9fe8fe9c87bb?auto=format&fit=crop&w=1000&q=80",
    galleryImages: [
  ...
  },
  {
    ...
    description: "Effortlessly understated luxury for warm afternoons. Spun from organic French flax linen with a breathable loose-fit shape, side pockets, and tortoise-shell button fastenings.",
    price: 290,
    originalPrice: 340,
    rating: 4.7,
    reviewCount: 31,
  ...
  },
  {
    ...
    description: "Command the boardroom with razor-sharp tailored elegance. Designed with padded shoulders, horn buttons, a fabric belt with gold hardware, and a tailored sheath fit.",
    price: 460,
    originalPrice: 560,
    rating: 4.8,
    reviewCount: 22,
    sizes: ["XS", "S", "M", "L"],
    colors: [
      { name: "Tailored Black", hex: "#111111" },
      { name: "Camel Tan", hex: "#C19A6B" },
      { name: "Grid Beige", hex: "#D7C4B7" }
    ],
    material: "90% Virgin Wool Crepe, 10% Cashmere",
    careInstructions: "Dry clean only.",
    stock: 9,
    thumbnail: "https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?auto=format&fit=crop&w=1000&q=80",
    galleryImages: [
  ...
  },
  {
    ...
    description: "Designed for nocturnal celebrations. Liquid metallic mesh drapes over the body with a plunging cowled back and structured hip gathering for maximum radiance.",
    price: 360,
    originalPrice: 420,
    rating: 4.9,
    reviewCount: 47,
    ...
    stock: 7,
    thumbnail: "https://images.unsplash.com/photo-1502716119720-b23a93e5fe1b?auto=format&fit=crop&w=1000&q=80",
    galleryImages: [
      "https://images.unsplash.com/photo-1502716119720-b23a93e5fe1b?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    description: "Float through summer days in weightless silk chiffon. Cascading tiers create enchanting motion, finished with hand-embroidered neckline trim and semi-sheer cap sleeves.",
    price: 410,
    originalPrice: 480,
    rating: 4.8,
    reviewCount: 33,
    sizes: ["XS", "S", "M", "L", "XL"],
    colors: [
      { name: "Sunlit Cream", hex: "#FFFDD0" },
      { name: "Blush Coral", hex: "#F08080" },
      { name: "Azure Blue", hex: "#0077BE" }
    ],
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Burgundy Satin", hex: "#800020" },
